...
**RoadArchitect** is a **Fabric** mod for **Minecraft 1.21.4** that automatically scans the world for villages and other structures, connecting them with roads to form a persistent travel network.  
