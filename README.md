...
**RoadArchitect** is a **Fabric** mod for **Minecraft 1.21.2** that automatically scans the world for villages and other structures, connecting them with roads to form a persistent travel network.
...
1. Install **[Fabric Loader](https://fabricmc.net/use/installer/)** `0.17.2` for **Minecraft 1.21.2**
2. Download the mod:
